...
return [
    ...
    "layout" => [
        ...
        "data" => [
            "baseTitle" => " | Solstråle Consulting",
            "bodyClass" => null,
            "favicon" => "favicon.png",
            "htmlClass" => null,
            "lang" => "sv",
    ...
    "views" => [
        ...
        [
            ...
            "data" => [
                "homeLink"      => "",
                "siteLogoText"  => "Solstråle Consulting",
                "siteLogoTextIcon" => "image/logo.png?width=70&height=70",
                "siteLogoTextIconAlt" => "Solstråle Consulting",
            ],
        ],
        [
            "region" => "header-col-2",
